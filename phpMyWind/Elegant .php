...
<div class="container">
	<div class="row">
      <div class="col-lg-12 col-md-12 col-xs-12">
             <div class="line-text">
             <span>企业文化</span><a href="index.html">您当前所在位置：首页 > 企业文化 </a>
		   </div>
	    </div>
	</div>
</div>
...
<div class="container">
	...
	<aside class="sideBar">	
		...
		<ul>
            ...
            <li><a href="<?php echo $row['linkurl']; ?>"><?php echo $row['title']; ?></a></li>
...
<div  class="col-lg-9 col-md-9 col-xs-9">
	...
	<?php
						$row=$dosql->GetOne("SELECT * FROM `#@__infolist` where classid=2 AND id=56 AND delstate='' AND checkinfo=true ORDER BY orderid ASC LIMIT 0,1;");
					?>
					<div class="aorise-img">
